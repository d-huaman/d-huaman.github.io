(function(){
  ...
  var data = {
    cloud:     { code:'COMP-01', type:'Comparador de imágenes', title:'Modelado 3D a partir de Nubes de Puntos', desc:'Aquí se mostrará el comparador ampliado nube de puntos (.LAS) vs. modelo 3D en Revit, o un video del recorrido de registro.', pattern:'', media:'<div class="gallery-row"><img src="assets/media/comp-01-nube-puntos.jpg" alt="Nube de puntos escaneada"><img src="assets/media/comp-01-modelo-3d.jpg" alt="Modelo 3D en Revit"></div>' },
    layers: {
